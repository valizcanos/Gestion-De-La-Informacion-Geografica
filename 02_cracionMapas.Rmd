...
library(sp)
library(raster)
theme_set(theme_bw()) ##?theme_bw establece el tema en blanco y negro es una función de ggplot2
...
Los sistemas de coordenadas geográficas se basan en una superficie esferoidal (ya sea verdaderamente esférica o elipsoidal) que se aproxima a la superficie de la Tierra. Un **datum** suele definir la superficie (radio para una esfera, eje mayor y eje menor o aplanamiento inverso para un elipsoide) y la posición de la superficie en relación con el centro de la Tierra. Por ejemplo:
<br>
...
# Los parámetros +lat_0=52, +lon_0=10, +x_0=4321000 y +y_0=3210000 son parámetros de la proyección de Lambert Azimuthal Equal Area (LAEA).

# La proyección LAEA es una proyección cartográfica que preserva el área y la forma de los continentes, pero distorsiona la distancia y la dirección. Esta proyección se utiliza comúnmente para representar regiones polares y se basa en un punto central que se utiliza como origen de coordenadas. Los parámetros +lat_0 y +lon_0 definen la latitud y longitud del punto central, mientras que +x_0 y +y_0 definen las coordenadas del punto central en metros.
